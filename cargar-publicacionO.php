...
if (!file_exists(''.$titulo.'/')) {
    mkdir('img/hero-slider/'.$titulo.'/', 0777, true);
}

$direccion="'img/hero-slider/$titulo/";
...
if ((($_FILES["archivo"]["type"] == "image/jpg")
   ...
   && in_array($extensionimg, $extensionespermitidas)) {
    ...
    config_set($config_data, "Publicacion $titulo", "titulo", $titulo);
    config_set($config_data, "Publicacion $titulo", "mensaje", $mensaje);
    config_set($config_data, "Publicacion $titulo", "imagen", $archivo);
